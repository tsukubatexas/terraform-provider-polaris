...
func terraformRestResourceDoc(tag string) string {
	...
	buf.WriteString("- `query_params` (Map of String, Sensitive) Query string parameters.\n")
	buf.WriteString("- `headers` (Map of String, Sensitive) Additional HTTP headers for this resource.\n")
...
func terraformRestCallDoc(tag string) string {
	...
	buf.WriteString("- `query_params` (Map of String, Sensitive) Query string parameters.\n")
	buf.WriteString("- `headers` (Map of String, Sensitive) Additional HTTP headers.\n")
