...
| `registerView` | `POST` | `/v1/{prefix}/namespaces/{namespace}/register-view` | Catalog API | Register a view in the catalog | `spec/iceberg-rest-catalog-open-api.yaml` |
...
| `signRequest` | `POST` | `/v1/{prefix}/namespaces/{namespace}/tables/{table}/sign` | Catalog API | Remotely signs requests to object storage | `spec/iceberg-rest-catalog-open-api.yaml` |
